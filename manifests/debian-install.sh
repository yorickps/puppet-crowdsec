...
main ()
{
  ...
  gpg_key_url="https://packagecloud.io/crowdsec/crowdsec/gpgkey"
  apt_config_url="https://packagecloud.io/install/repositories/crowdsec/crowdsec/config_file.list?os=${os}&dist=${dist}&source=script"

  apt_source_path="/etc/apt/sources.list.d/crowdsec_crowdsec.list"
  apt_keyrings_dir="/etc/apt/keyrings"
  if [ ! -d "$apt_keyrings_dir" ]; then
    mkdir -p "$apt_keyrings_dir"
  fi
  gpg_keyring_path="$apt_keyrings_dir/crowdsec_crowdsec-archive-keyring.gpg"
  gpg_key_path_old="/etc/apt/trusted.gpg.d/crowdsec_crowdsec.gpg"
